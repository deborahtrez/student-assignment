//will be for creating a new student on the platform
...
class RegisterStudent extends Component {
    ...
    onSubmit(event){
        ...
        const student = { username: this.state.username }
        console.log(student)
        ...
        return(
            <div>
               ...
               <form onSubmit={this.onSubmit}>
                   ...
                   <input type='text'  onChange={this.changedUsername} value={this.state.username} className='form-group form-control' />
